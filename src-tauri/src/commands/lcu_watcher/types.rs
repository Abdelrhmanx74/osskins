...
pub static PARTY_INJECTION_DONE_THIS_PHASE: Lazy<AtomicBool> = 
  Lazy::new(|| AtomicBool::new(false));

// Track last champion share time to debounce rapid ARAM rerolls
pub static LAST_CHAMPION_SHARE_TIME: Lazy<std::sync::Mutex<std::collections::HashMap<u32, std::time::Instant>>> =
