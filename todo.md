...
- [x] Panic in changing champs swift and aram, etc..
...
- [x] issue when picking the skin after locking in the champ in aram or selective modes 
- [-] checkout the cached mods
- [x] when open stay at prev tray state
